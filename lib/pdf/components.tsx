...
export function CoverPage({ logoUri, title, subtitle, date, score }: CoverPageProps) {
  return (
    <Page size="A4" style={baseStyles.coverPage}>
      <View style={baseStyles.coverContent}>
        ...
        <Text style={baseStyles.coverTitle}>{title}</Text>
        <Text style={baseStyles.coverSubtitle}>{subtitle}</Text>
        <Text style={baseStyles.coverSubtitle}>{date}</Text>
      ...
      <Text style={baseStyles.coverFooter}>Generated by Selo Studios</Text>
    </Page>
  )
}
