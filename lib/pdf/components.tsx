...
export function CoverPage({ logoUri, title, subtitle, date, score, variant = 'dark' }: CoverPageProps) {
  ...
  return (
    <Page size="A4" style={pageStyle}>
      <View style={baseStyles.coverContent}>
        ...
        {subtitle && <Text style={[baseStyles.coverSubtitle, { color: subtitleColor }]}>{subtitle}</Text>}
      ...
      <Text style={[baseStyles.coverFooter, isLight ? { color: colors.textLight } : {}]}>Generated by Selo Studios</Text>
    </Page>
  )
}
