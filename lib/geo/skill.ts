 ...
 * Generative Engine Optimization. It focuses on the aspects that AI engines
...
export const GEO_QUALITY_SKILL = `
You are analyzing web content for Generative Engine Optimization (GEO) - the practice of optimizing content to be cited by AI search engines like ChatGPT, Claude, Perplexity, and Gemini.
