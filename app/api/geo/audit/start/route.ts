...
import { runGEOAuditBackground } from '@/lib/geo/background'
 ...
 * Creates a GEO audit and returns the audit ID for navigation
 */
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    after(async () => {
      try {
        await runGEOAuditBackground(audit.id, url)
      } catch (err) {
