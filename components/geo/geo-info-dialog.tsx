    ...
    <Dialog>
      <DialogTrigger asChild>
        <button
          ...
          aria-label="Learn about GEO Audits"
        >
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>About GEO Audits</DialogTitle>
          <DialogDescription>
            Understanding Generative Engine Optimization and how we analyze your content
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 text-sm">
          ...
          <div className="space-y-2">
            ...
            <ol className="list-inside list-decimal space-y-2 text-muted-foreground">
              <li>We crawl your website and analyze its structure</li>
              <li>Run 20 programmatic checks for technical validation (fast, $0 cost)</li>
              <li>Use AI to analyze content quality on your selected sample of pages</li>
